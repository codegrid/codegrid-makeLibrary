...
(function() {
  ...
  (function($, window, document) {
    ...
    ns.FullPhotoDialog = (function() {
      ...
      FullPhotoDialog.prototype.initializeInside = function($dialogRoot, startindex) {
        var _this = this;
      ...
      FullPhotoDialog.prototype.open = function(itemsData, startindex) {
        var defer, src,
          _this = this;
        ...
        window.domwindowApi.open(src, {
          ...
          afteropen: function(e, data) {
            _this.initializeInside(data.dialog, startindex);
